...
const columns: GridColDef<MYardActivity>[] = [
  {
    field: "yardActivity",
    headerName: "Activity",
    type: "string",
  ...
  {
    field: "yardActivityCategory",
    headerName: "Activity Category",
    type: "string",
    width: 150,
  },
  {
    field: "pubToKafkaTopic",
    headerName: "Kafka",
    type: "string",
    width: 150,
  },
...
export default function Client({ data }: { data: MYardActivity[] | null }) {
  ...
  function onRowDelete() {
    ...
    axios
      .delete<Response<null, string>>(
        `/yard-management-system/api/yard-activities/${selectedRowId}`,
      )
      .then((r) => {
        router.refresh();
