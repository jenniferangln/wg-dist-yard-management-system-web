...
const columns: GridColDef<MYardScenario>[] = [
  {
    field: "scenarioCode",
...
export default function Client({ data }: { data: MYardScenario[] | null }) {
  ...
  function onRowDelete() {
    ...
    axios
      .delete<Response<null, string>>(
        `/yard-management-system/api/yard-scenarios/${selectedRowId}`,
      )
      .then((r) => {
        router.refresh();
